...
export default function CartPage() {
  ...
  return (
    <div className="py-8 md:py-12 bg-gray-50 min-h-screen">
      <Container>
        <div className="mb-8">
          <Link href="/" className="inline-flex items-center text-sm text-gray-500 hover:text-amber-900 transition-colors">
            <ArrowLeft className="w-4 h-4 mr-1" />
            Continuar comprando
          </Link>
          <h1 className="text-3xl md:text-4xl font-serif font-bold text-amber-900 mt-4">
            Seu Carrinho
          </h1>
        </div>
          ...
          <div className="w-full lg:w-2/3 flex flex-col gap-4">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6">
              {MOCK_CART_ITEMS.map((item) => {
                ...
                return (
                  <div key={item.id} className="flex gap-4 py-4 border-b border-gray-50 last:border-0 last:pb-0 first:pt-0 relative group">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                ...
                <div className="flex gap-2">
                  <div className="relative grow">
                    ...
                    <input 
                      ...
                      className="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 sm:text-sm"
                    />
                  </div>
                  <Button variant="secondary" className="px-4">Calcular</Button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 mb-6">
                <div className="flex justify-between text-gray-600">
                  <span>Subtotal</span>
                  <span className={totalDesconto > 0 ? "line-through text-gray-400" : ""}>
                ...
                <div className="border-t border-gray-100 mt-3 pt-3 flex justify-between items-end">
              ...
              <Button className="w-full py-6 text-lg rounded-xl shadow-md bg-green-600 hover:bg-green-700 text-white flex items-center justify-center gap-2">
